...
impl CodeGenerator for PythonBackend {
    fn generate(&self, program: &Program) -> Result<String> {
        ...
        // Helper for Parity (Bool lowercasing)
        buffer.push_str("def omni_print(val):\n");
    ...
    fn gen_expression(&self, expr: &Expression) -> String {
        match expr {
            ...
            Expression::Call { function, args } => {
                ...
                if func_name == "print" || func_name == "io.print" || func_name == "io_print" {
                    return format!("omni_print({})", args_str);
                }
                if func_name == "String" {
