...
Task.__attributes = [{ name: 'entity', args: [] }];
...
api_get_tasks.__attributes = [{ name: 'get', args: ["/api/tasks"] }];

function api_create_task(title) {
    print("[API] POST /api/tasks - Creating: " + title);
}
api_create_task.__attributes = [{ name: 'post', args: ["/api/tasks"] }];

function api_delete_task(id) {
    print("[API] DELETE /api/tasks/" + id);
}
api_delete_task.__attributes = [{ name: 'delete', args: ["/api/tasks/:id"] }];
...
;
TaskManager.__attributes = [{ name: 'screen', args: ["TaskManager"] }];
