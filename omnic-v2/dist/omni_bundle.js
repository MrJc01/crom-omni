...
if (!expr) return null;
        ...
        if (expr.kind === 16) { // NODE_ASSIGNMENT
            ...
            if (left.kind === 15) { // Identifier
                ...
                const obj = OmniVM_eval_expression(self, left.object);
                if (obj) {
...
function LockFile_load(project_dir) {
    let lock = new LockFile({ version: "1.0", packages: {  } });
// const fs = require('fs'); (hoisted)
        // const path = require('path'); (hoisted)
...
function VisualGraph_new() {
    return new VisualGraph({ nodes: [], edges: [], viewport: { x: 0, y: 0, zoom: 1 }, metadata: { version: "1.0", generated: "" } });
}
